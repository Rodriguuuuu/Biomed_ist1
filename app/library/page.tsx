...
function skillVecFromCompany(c: Company) {
  // Perfis base por categoria (só skills que existem em SKILLS)
  const map: Record<Company['category'], Partial<Record<(typeof SKILLS)[number], number>>> = {
    ...
    Consulting: {
      // Removido "Communication"; redistribuí o peso por skills existentes
      'Management/HASS': 0.42,          // 0.30 + parte do "communication"
      'Health Economics/Value': 0.16,
      'Statistics/Data Science': 0.10,
      'Algorithms & Modelling': 0.18,   // 0.12 + parte do "communication"
      Programming: 0.14,                // 0.08 + parte do "communication"
    },
  };
